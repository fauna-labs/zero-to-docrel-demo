...
<template>
  <div
    class="flex flex-col h-screen overflow-auto pa-0 bg-white dark:bg-gray-800 dark:border-gray-700 text-gray-800 dark:text-white">
    ...
    <Product v-if="addOrUpdateProduct" @exit-add-product="productAdded" :product="selectedProduct" />
  </div>
</template>
