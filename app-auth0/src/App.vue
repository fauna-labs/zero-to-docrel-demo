  ...
  <div class="flex bg-white border-r dark:bg-gray-900 dark:border-gray-700">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8">
      ...
      <div class="flex flex-col justify-between flex-1 mt-6">
        ...
        <div v-if="isAuthenticated" class="dark:text-gray-200">
          {{ user.name }}
        </div>
      </div>
    </div>

    <div aria-label="Top" class="w-screen max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="border-b border-gray-200">
        <div class="flex h-16 items-center">
          <div class="ml-auto flex items-center">
            <div class="lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
              <div class="text-sm font-medium text-gray-700 hover:text-gray-800">
                <a v-if="isAuthenticated" href="#" @click="logout">Log out</a>
